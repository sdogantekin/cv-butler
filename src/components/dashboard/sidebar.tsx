...
export function Sidebar({
  ...
  return (
    <aside className="flex min-h-screen w-[260px] shrink-0 flex-col border-r bg-card p-5">
      <div className="mb-10 flex items-center gap-1.5 rounded-lg bg-primary px-3.5 py-1.5 text-sm font-bold text-primary-foreground">
        <LogoIcon size={20} />
        CV Butler
      </div>
