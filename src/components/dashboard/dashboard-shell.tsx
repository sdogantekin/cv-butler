...
export function DashboardShell({
  ...
  return (
    <div className="flex min-h-screen flex-1">
      <Sidebar activeTab={tab} onTabChange={setTab} userName={userName} logoutAction={logoutAction} />
      <main className="min-w-0 flex-1 px-12 py-10">
        {tab === "home" && <HomeTab userName={userName} userEmail={userEmail} onTabChange={setTab} />}
        {tab === "ats" && (
          <AtsTab
